...
const ALLOWED_EVENTS = new Set([
  ...
  '[DIRECT OVERBOARD RENDER FORCED BY QUEUE RESULT]',
  '[GO TO BANS OPEN BANS BLOCKED QUEUE EXISTS]',
  ...
  '[HOLD BLOCK DECISION]',
  '[HOLD CLEAR]',
  '[SHOW NEXT POST SELECTED ENTER]',
  '[SHOW NEXT RETURN]',
  '[SYNC DISPLAY CALL]',
  '[SYNC DISPLAY SKIPPED]',
  '[SYNC DISPLAY ENTER]',
  '[SYNC DISPLAY EXIT]',
  '[DISPLAY COMMIT CALL SITE]',
  '[RESULT GO TO BANS BUTTON RAW CLICK]',
  '[GO TO BANS CLICK ENTER]',
  '[GO TO BANS DISMISS START]',
  '[GO TO BANS DISMISS RESULT]',
  '[GO TO BANS SHOULD SHOW NEXT]',
  '[GO TO BANS SHOW NEXT CALLED]',
  '[GO TO BANS SHOW NEXT NOT CALLED]',
  ...
  'GO_TO_BANS_PAYLOAD_SWITCH_TRACE_CLICK',
  'GO_TO_BANS_AFTER_FINALIZE',
  'NEXT_PAYLOAD_SELECTION_TRACE',
  'PROVIDERS_RESULT_STALE_ACTIVE_TRACE',
  'RESULT_VISIBLE_OWNER_ACTIVE_SYNC',
  'RESULT_GO_TO_BANS_OWNER_TRANSITION',
  'RESULT_REOPEN_BLOCKED_BY_OWNER_CONSUMED',
  'GO_TO_BANS_NEXT_OVERLAY_ATOMIC_COMMIT',
  'GO_TO_BANS_BANS_LAYER_SUPPRESSED_FOR_NEXT_OVERLAY',
  'GO_TO_BANS_EMPTY_RUNTIME_DEFERRED_TO_ASYNC_CONTINUE',
  'OVERLAY_EMPTY_GAP_CLASSIFIED',
  ...
  'BANS_SECTION_AUTO_OPEN_REMOVED_PATH',
  'LOBBY_BANS_INDICATOR_SOURCE',
  'LOBBY_BANS_CLICK_DECISION',
  'CHAIN_START_REJECTED_FROM_LOBBY_CLICK',
  'POST_SUCCESS_CHAIN_START_SOURCE',
  'OWNER_QUEUE_EMPTY_DURING_CHAIN',
  'CHAIN_ENDED_WITH_INDICATOR_STILL_ON',
  'LOBBY_CLICK_NO_PREFETCH_PATH',
  'POST_SUCCESS_PREFETCH_REHYDRATED_CHAIN',
  'BACKEND_PENDING_FETCH_RESULT',
  ...
  'SUCCESS_EMPTY_SHELL_HOLD_ENTER',
  'SUCCESS_EMPTY_SHELL_HOLD_RELEASE',
  'SUCCESS_PRESENTATION_HANDOFF_ARMED',
  'SUCCESS_PRESENTATION_HANDOFF_RELEASED',
  'ACTION_MATCHING_RESULT_STAGED',
  'ACTION_MATCHING_RESULT_MATERIALIZED',
  'ACTION_MATCHING_RESULT_DEDUPED',
  'ACTION_COMPLETION_RELEASED_WITHOUT_RESULT',
  'ACTION_RESULT_CHAIN_OPENED',
  'ACTION_EARLY_RESULT_PARKED',
  'ACTION_EARLY_RESULT_CLAIMED',
  'ACTION_RESULT_WAIT_STARTED',
