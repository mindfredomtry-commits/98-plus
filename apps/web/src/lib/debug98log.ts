...
const ALLOWED_EVENTS = new Set([
  ...
  '[CHECK RESULT HOLD STARTED]',
  '[CHECK RESULT HOLD RELEASED WITH RESULT]',
  '[CHECK RESULT HOLD RELEASED TIMEOUT]',
  '[CHECK RESULT ARRIVED DURING HOLD]',
  '[CHECK RESULT LATE BLOCKED]',
  '[CHECK RESULT LATE QUEUED AFTER HEAD]',
  '[CHECK RESULT ADVANCE BLOCKED]',
