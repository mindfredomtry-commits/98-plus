...
const ALLOWED_EVENTS = new Set([
  ...
  '[INCOMING CONSUMED AFTER OVERKILL]',
  '[RESULT CONTINUE AFTER OVERKILL]',
  '[OVERKILL PARENT INCOMING STILL IN QUEUE]',
  '[OVERKILL PARENT INCOMING REJECTED]',
  '[QUEUE HEAD AFTER RESULT CONTINUE]',
